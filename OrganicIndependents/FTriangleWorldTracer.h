...
they exist (yet) in the UniquePointContainer used by the base class, when this class is used. (that comes later).
...
class FTriangleWorldTracer : public FTriangleTracerBase
{
	...
	private:
		...
		struct LineLocalizer
		{
			...
			FTrianglePoint localizedStartPoint;
			FTrianglePoint localizedEndPoint;
