...
void CalibrateableOREKeyPair::calibrate()
{
...
void CalibrateableOREKeyPair::isCalibratable(int* in_blueprintLocationPtr, float in_normalizedSlopeValue, float in_pointAxyz, float in_pointBxyz, float in_pointCxyz, float in_keyAfloat, float in_keyBfloat)
{
